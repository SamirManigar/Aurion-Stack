        ...
        <div className="grid grid-cols-2 gap-px border border-white/5 rounded-xl overflow-hidden bg-white/5">
          {builds.map((item, i) => (
            <motion.div
              ...
              className="group flex flex-col sm:flex-row items-start gap-2 sm:gap-4 bg-background p-3 sm:px-6 sm:py-5 hover:bg-white/[0.03] transition-colors duration-300"
            >
