...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.aurionstack.dev/visioscript" },
  openGraph: {
    type: "website",
    url: "https://www.aurionstack.dev/visioscript",
    ...
    images: [{ url: "/aurionstack-logo.webp", width: 1200, height: 630, alt: "VisioScript by Aurion Stack" }],
  },
  twitter: {
