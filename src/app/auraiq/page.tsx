...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.aurionstack.dev/auraiq" },
  openGraph: {
    type: "website",
    url: "https://www.aurionstack.dev/auraiq",
    ...
    images: [{ url: "/aurionstack-logo.webp", width: 1200, height: 630, alt: "AuraIQ by Aurion Stack" }],
  },
  twitter: {
