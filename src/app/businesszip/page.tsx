...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.aurionstack.dev/businesszip" },
  openGraph: {
    type: "website",
    url: "https://www.aurionstack.dev/businesszip",
    ...
    images: [{ url: "/aurionstack-logo.webp", width: 1200, height: 630, alt: "BusinessZip by Aurion Stack" }],
  },
  twitter: {
